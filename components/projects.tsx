...
const projects = [
  {
    ...
    category: "Municipal",
    description:
      "Comprehensive inventory of 25,000 hectares for regional planning authority, including species mapping and growth projections.",
    stats: "25,000 ha",
  },
  {
    ...
    category: "Private",
    description:
      "Detailed carbon sequestration analysis and verification documentation for forest carbon credit certification.",
        ...
        <div className="grid md:grid-cols-3 gap-6">
          {projects.map((project) => (
            <Card key={project.title} className="group overflow-hidden border-border hover:shadow-lg transition-all duration-300">
              <div className="aspect-[16/10] relative overflow-hidden bg-[oklch(0.16_0.03_195)]">
                {project.image ? (
                  <Image
                    src={project.image}
                    alt={project.title}
